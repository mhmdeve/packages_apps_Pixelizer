...
import com.pixelizer.settings.preferences.SystemSettingEditTextPreference;
...
public class QuickSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.pixelizer_settings_quicksettings);
        ...
        if (footerString != null && !footerString.isEmpty())
            ...
            mFooterString.setText("PixelPlusUI");
            Settings.System.putString(getActivity().getContentResolver(),
                    Settings.System.QS_FOOTER_TEXT_STRING, "PixelPlusUI");
        }
    }
