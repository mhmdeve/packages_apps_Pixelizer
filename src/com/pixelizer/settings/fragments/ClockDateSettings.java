...
public class ClockDateSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.pixelizer_settings_clock_date);
    ...
    public void onResume() {
        ...
        final boolean hasNotch = CustomUtils.hasNotch(getActivity());
        final int notchType = CustomUtils.getCutoutType(getActivity());
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.pixelizer_settings_clock_date;
                    result.add(sir);
                    return result;
                }
